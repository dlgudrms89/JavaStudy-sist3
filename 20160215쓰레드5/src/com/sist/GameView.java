...
public class GameView extends JPanel{
    ...
    public GameView()
    {
    	x=340;
    	y=430;
    	back=Toolkit.getDefaultToolkit().getImage("c:\\이미지\\sky.png");
    	move=Toolkit.getDefaultToolkit().getImage("c:\\이미지\\spider1.png");
    	chong=Toolkit.getDefaultToolkit().getImage("c:\\이미지\\w0.png");
